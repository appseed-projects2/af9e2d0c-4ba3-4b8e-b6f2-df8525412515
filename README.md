...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-19 19:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/af9e2d0c-4ba3-4b8e-b6f2-df8525412515.git
$ cd af9e2d0c-4ba3-4b8e-b6f2-df8525412515
```
